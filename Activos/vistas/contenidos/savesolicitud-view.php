 ...
 if (isset($_SESSION['usuario'])) {   
   ...
   $sociedad = $clase_combo->buscar_sociedad_controlador();
 } 
 else{
 ...
 <div class="page-header float-right">
  <div class="page-title">
   <ol class="breadcrumb text-right">
    ...
    <li class="active">Realizar Ingreso</li>
  </ol>
</div>
</div>
</div>
...
<div class="col-md-4">
 ...
 <div class="form-grupo">
   <div class="input-group">
     <div class="input-group-addon"><i style="color: black;"  class="fa fa-calendar-o"></i></div>
     <select name="cmbvidautil_reg" class="form-control">
      <option value="0">Seleccione el tiempo en años</option>
...
<div class="col-md-3">
 <label>Sociedad <strong style="color: black;"></strong></label>
 <div class="form-grupo">
   <div class="input-group">
     <div class="input-group-addon"><i style="color: black;"  class="fa fa-group"></i></div>
     <select name="txtsociedad_reg" class="form-control">
      <option value="0">Seleccione la sociedad</option>
      <?php foreach ($sociedad as $s): ?>
        <option value="<?php echo $s['PKNit_Razon'] ?>">
          <?php echo $s['Descripcion_Razon']; ?>
        </option>  
      <?php endforeach ?>
    </select>
  </div>
