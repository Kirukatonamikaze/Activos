     ...
     <div class="col-sm-4">
      <div class="page-header float-left">
       <div class="page-title">
        <h1><i class="menu-icon fa fa-bell"></i> Trasladar Activos /<small>Realizar registro</small></h1>
      </div>
    </div>
  </div>
  <div class="col-sm-8">
   <div class="page-header float-right">
    <div class="page-title">
      <ol class="breadcrumb text-right">
        ...
        <li><a href="#">Trasladar Activos</a></li>
        <li class="active">Realizar Traslado</li>
      </ol>
    </div>
  </div>
</div>
   ...
   <div class="col-sm-12">
    <div class="card" style="padding: 20px;"> 
      <form action="<?php echo(SERVERURL); ?>ajax/registrosAJAX.php" method="post" data-form="search" class="FormularioAJAX" autocomplete="off" enctype="multipart/form-data">
        <div class="col-sm-12"> 
         <div class="col-md-6">
          <label> <h6>Finca Origen</h6> <strong style="color: black;"></strong></label>
      ...
      <div  class="col-md-6">
        ...
        <div class="form-grupo">
         <div class="input-group">
           <div class="input-group-addon"><i style="color: black;"  class="fa  fa-toggle-down"></i></div>
           <select name="cmbfinca_destino" class="form-control" id="cmbfinca2">
            <option value="0">Seleccione la finca</option>
            <?php foreach ($finca as $f): ?>
              <option value="<?php echo $f['PKCodigo'] ?>"><?php echo $f['Nombre_finca']; ?></option>
            <?php endforeach ?>
...
<div class="col-sm-12"> 
 <div  style="margin-top: 70px;" class="col-md-6">
   <label> <h6>Motivo Traslado</h6><strong style="color: black;"></strong></label>
   <div class="form-grupo">
    <div class="input-group">                          
...
<div class="col-md-4">
  <label> <h6>Documento Recibe</h6> <strong style="color: black;"></strong></label>
  <div class="form-grupo">
    <div class="input-group">
     <div class="input-group-addon"><i style="color: black;"  class="fa fa-book"></i></div>
     <input  required="" id="txtdocumento_reponsabletrasladorecibe" name="txtdocumento_reponsabletrasladorecibe"  class="form-control" placeholder="Documento responsable recibe traslado" >
   </div>
 </div>
</div> 
<div class="col-md-4">
  <label> <h6>Nombre Recibe</h6> <strong style="color: black;"></strong></label>
  <div class="form-grupo">
    <div class="input-group">
     <div class="input-group-addon"><i style="color: black;"  class="fa fa-male"></i></div>
     <input readonly="readonly" id="txtnombre_reponsabletrasladorecibe"  name="txtnombre_reponsabletrasladorecibe"  class="form-control" placeholder="Nombre responsable recibe traslado" >
   </div>
 </div>
</div>         
</div>  
...
<div class="col-md-12" style="margin-top: 60px;">
  <button style="border-radius: 5px;  margin-left: 450px; " type="submit" class="btn btn-success"><i class="fa fa-exchange"></i>&nbsp; Trasladar Activo</button>
</div>   
...
<div class="row" >
  ...
  <div style="margin-top: -39px;" class="col-md-6 text-left">
    <form action="<?php echo(SERVERURL); ?>ajax/registrosAJAX.php" method="post" data-form="delete" class="FormularioAJAX" autocomplete="off">
      ...
      <button style="border-radius: 5px;" name="btn-Cancelar" class="btn btn-danger" type="submit"><i class="fa fa-times"></i> Cancelar Traslado</button>
